                        ...
                        <div class="card-body">
                            <div class="row">
                                ...
                                <div class="col-md-12 col-lg-3">
                                    <div class="nav flex-column nav-pills" id="my-account-tabs" role="tablist"
                                        aria-orientation="vertical">
                                        <a class="nav-link {{ !Session::get('tab') || Session::get('tab') != 'password' ? 'active' : '' }}"
                                        ...
                                        <a class="nav-link {{ Session::get('tab') && Session::get('tab') == 'password' ? 'active' : '' }}"
                                            id="v-pills-password-tab" data-toggle="pill" href="#v-pills-password"
                                            role="tab" aria-controls="v-pills-password" aria-selected="false">Change
                                            Password</a>
                                    </div>
                                </div>
                                <div class="col-md-12 col-lg-9">
                                    <div class="tab-content" id="my-account-tabsContent">
                                        <div class="tab-pane fade show {{ !Session::get('tab') || Session::get('tab') != 'password' ? 'active' : '' }}"
                                            ...
                                            <form action="{{ route('my-profile.update') }}" method="post"
                                                ...
                                                <div class="form-group">
                                                    <img src="{{ $profile->profile_image ? $profile->image_url : asset('assets/img/avatars/1.jpg') }}"
                                                        class="w-50 rounded-circle" alt="{{ $profile->name }}">
                                                    <div class="file-upload">
                                                        <label for="upload"
                                                            class="btn btn-primary m-b-0 m-l-5 m-r-5">Upload a new
                                                            picture</label>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <input type="email" readonly class="form-control" autocomplete="email"
...
@push('custom-scripts')
    <script>
        ...
        let old_password = {!! json_encode($errors->has('old_password')) !!};
        let new_password = {!! json_encode($errors->has('new_password')) !!};
        let confirm_password = {!! json_encode($errors->has('confirm_password')) !!};
        if (old_password || new_password || confirm_password) {
            $('#v-pills-password-tab').click();
        }
